...
namespace TerrainPloughTools
{
    ...
    internal struct ApplyFlattenBrushParrallelJob : IJobParallelFor
    {
        /// <summary>
        ...
        public void Execute(int index) {
            ...
            nBrushMap[(y * brushmapPitch) + x] = math.clamp(math.lerp(currentHeight, height, hardness * dt * mask), 0, height);
        }
