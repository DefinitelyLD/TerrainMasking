...
namespace AmplifyShaderEditor
{
	...
	{
		[MenuItem( "Assets/Create/Amplify Shader/BOXOPHOBIC/The Visual Engine/Element", false, 85 )]
		public static void ApplyTemplateBOXOPHOBICTheVisualEngineElement()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "f4f273c3bb6262d4396be458405e60f9" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/BOXOPHOBIC/The Visual Engine/Lit", false, 85 )]
		public static void ApplyTemplateBOXOPHOBICTheVisualEngineLit()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "28cd5599e02859647ae1798e4fcaef6c" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/BOXOPHOBIC/The Visual Engine/Multi", false, 85 )]
		public static void ApplyTemplateBOXOPHOBICTheVisualEngineMulti()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "0f19abbca861964499319ef2f87fcde2" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/BOXOPHOBIC/The Visual Engine/Unlit", false, 85 )]
		public static void ApplyTemplateBOXOPHOBICTheVisualEngineUnlit()
		{
