...
namespace TheVisualEngine
{
    public class TVEMaterialManager : EditorWindow
    {
        ...
        {
        "All Material Settings", "Render Settings", "Surface Settings", "Coloring Settings", "Weather Settings", "Fading Settings", "Lighting Settings", "Transform Settings", "Motion Settings", "Normal Settings",
        };
        ...
        List<TVEPropertyData> transformData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_ConformNormalValue", "Conform Normal", -9000, 0, 1, false, false),
        };
        ...
        List<TVEPropertyData> normalData = new List<TVEPropertyData>
        {
            ...
            new TVEPropertyData("_NormalFormMode", "Normal Form Mode", -9000, "Multiply 0 Additive 1", false),
        ...
        void OnEnable()
        {
            ...
            settingsIndex = Convert.ToInt16(SettingsUtils.LoadSettingsData(userFolder + "/User/The Visual Engine/Material Settings.asset", MOTION_INDEX));
        }
