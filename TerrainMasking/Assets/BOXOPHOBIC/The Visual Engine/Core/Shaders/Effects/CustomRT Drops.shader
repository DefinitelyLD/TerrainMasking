	...
	SubShader
	{
        ...
        Pass
        {
            ...
            float4 frag(ase_v2f_customrendertexture IN ) : COLOR
            {
				...
				half2 Final_DirWS311 = -((lerpResult130_g77120).xy*2.0 + -1.0);
...
ASEEND*/
//CHKSM=4AB7A364D3FE8FD838B4DDBC30CC710105C36896