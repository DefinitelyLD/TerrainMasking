...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoOverlay
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g23469 = _SeasonRemap.x;
				half temp_output_9_0_g23469 = ( TVE_SeasonLerp - temp_output_7_0_g23469 );
				half TVE_SeasonLerp54_g23453 = saturate( saturate( ( temp_output_9_0_g23469 / ( _SeasonRemap.y - temp_output_7_0_g23469 ) ) ) );
				...
				half2 vertexToFrag11_g23476 = ( ( lerpResult1899_g23453 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g23476;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g23476 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g23453 = tex2D( _MainTex, vertexToFrag11_g23476 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g23470 = clamp( (MainTex_RGBA587_g23453).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g23460 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g23460).xxx;
				half3 temp_output_9_0_g23460 = ( clampResult17_g23470 - temp_cast_2 );
				...
				half clampResult17_g23471 = clamp( (MainTex_RGBA587_g23453).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23459 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g23459 = ( clampResult17_g23471 - temp_output_7_0_g23459 );
				...
				half temp_output_7_0_g23475 = 1.0;
				half temp_output_9_0_g23475 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23475 );
				half lerpResult18_g23473 = lerp( 1.0 , saturate( ( temp_output_9_0_g23475 / ( _ElementVolumeFadeValue - temp_output_7_0_g23475 ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g23453 = ( _ElementIntensity * Element_Remap_A74_g23453 * Element_Params_A1737_g23453 * i.ase_color.a * Element_Falloff1883_g23453 * lerpResult18_g23473 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoOverlay
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g23466 = temp_cast_3;
				half3 break68_g23466 = Input_Color94_g23466;
				half clampResult80_g23466 = clamp( max( max( break68_g23466.x , break68_g23466.y ) , break68_g23466.z ) , 0.1 , 10000.0 );
				half4 color1874_g23453 = IsGammaSpace() ? half4(0.2,0.5,1,0) : half4(0.03310476,0.2140411,1,0);
				half3 Input_Tint76_g23466 = (color1874_g23453).rgb;
				half3 Element_Valid47_g23466 = ( clampResult80_g23466 * Input_Tint76_g23466 );
				half clampResult17_g23471 = clamp( (MainTex_RGBA587_g23453).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23459 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g23459 = ( clampResult17_g23471 - temp_output_7_0_g23459 );
				half Element_Remap_A74_g23453 = saturate( ( ( temp_output_9_0_g23459 / ( _MainTexAlphaRemap.y - temp_output_7_0_g23459 ) ) + 0.0001 ) );
				...
				half Element_Alpha56_g23453 = ( _ElementIntensity * Element_Remap_A74_g23453 * Element_Params_A1737_g23453 * i.ase_color.a * Element_Falloff1883_g23453 * lerpResult18_g23473 );
				half Final_Extras_A241_g23453 = Element_Alpha56_g23453;
				half Input_Alpha48_g23466 = Final_Extras_A241_g23453;
				half4 appendResult58_g23466 = (half4(Element_Valid47_g23466 , Input_Alpha48_g23466));
				
				
				finalColor = appendResult58_g23466;
				return finalColor;
			}
			ENDCG
		}
...
ASEEND*/
//CHKSM=1FB159A653E6304D6E941E5BDF6B99609D24B021