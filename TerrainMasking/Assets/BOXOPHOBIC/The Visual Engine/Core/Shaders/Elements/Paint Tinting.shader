...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintTinting
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g76896 = _SeasonRemap.x;
				half temp_output_9_0_g76896 = ( TVE_SeasonLerp - temp_output_7_0_g76896 );
				half TVE_SeasonLerp54_g76880 = saturate( saturate( ( temp_output_9_0_g76896 / ( _SeasonRemap.y - temp_output_7_0_g76896 ) ) ) );
				...
				half2 appendResult1900_g76880 = (half2(ase_worldPos.x , ase_worldPos.z));
				half2 lerpResult1899_g76880 = lerp( ( 1.0 - v.ase_texcoord.xy ) , appendResult1900_g76880 , _ElementUVsMode);
				half2 vertexToFrag11_g76903 = ( ( lerpResult1899_g76880 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord2.xy = vertexToFrag11_g76903;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g76903 = i.ase_texcoord2.xy;
				half4 MainTex_RGBA587_g76880 = tex2D( _MainTex, vertexToFrag11_g76903 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g76897 = clamp( (MainTex_RGBA587_g76880).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g76887 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g76887).xxx;
				half3 temp_output_9_0_g76887 = ( clampResult17_g76897 - temp_cast_2 );
				...
				half clampResult17_g76898 = clamp( (MainTex_RGBA587_g76880).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g76886 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g76886 = ( clampResult17_g76898 - temp_output_7_0_g76886 );
				...
				half temp_output_7_0_g76902 = 1.0;
				half temp_output_9_0_g76902 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g76902 );
				half lerpResult18_g76900 = lerp( 1.0 , saturate( ( temp_output_9_0_g76902 / ( _ElementVolumeFadeValue - temp_output_7_0_g76902 ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g76880 = ( _ElementIntensity * Element_Remap_A74_g76880 * Element_Params_A1737_g76880 * i.ase_color.a * Element_Falloff1883_g76880 * lerpResult18_g76900 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintTinting
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Element_Color1756_g76880 = ( Element_Remap_RGB1555_g76880 * Element_Params_RGB1735_g76880 * (i.ase_color).rgb );
				half3 Final_Colors_RGB142_g76880 = ( (lerpResult30_g76880).rgb * Element_Color1756_g76880 );
				half3 Input_Color94_g76888 = Final_Colors_RGB142_g76880;
				half3 Element_Valid47_g76888 = Input_Color94_g76888;
				half clampResult17_g76898 = clamp( (MainTex_RGBA587_g76880).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g76886 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g76886 = ( clampResult17_g76898 - temp_output_7_0_g76886 );
				half Element_Remap_A74_g76880 = saturate( ( ( temp_output_9_0_g76886 / ( _MainTexAlphaRemap.y - temp_output_7_0_g76886 ) ) + 0.0001 ) );
				...
				half Element_Alpha56_g76880 = ( _ElementIntensity * Element_Remap_A74_g76880 * Element_Params_A1737_g76880 * i.ase_color.a * Element_Falloff1883_g76880 * lerpResult18_g76900 );
				half Final_Colors_A144_g76880 = ( (lerpResult30_g76880).a * Element_Alpha56_g76880 );
				half Input_Alpha48_g76888 = Final_Colors_A144_g76880;
				half4 appendResult58_g76888 = (half4(Element_Valid47_g76888 , Input_Alpha48_g76888));
				
				
				finalColor = appendResult58_g76888;
				return finalColor;
			}
			ENDCG
		}
...
ASEEND*/
//CHKSM=9FDCD2B6E897D0EAF63C361500D78A057FC992C1