...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsFlowInteractionSimple
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				half4 MainTex_RGBA587_g1 = tex2D( _MainTex, ( 1.0 - i.ase_texcoord1.xy ) );
				float3 temp_cast_0 = (0.0001).xxx;
				float3 temp_cast_1 = (0.9999).xxx;
				float3 clampResult17_g22408 = clamp( (MainTex_RGBA587_g1).rgb , temp_cast_0 , temp_cast_1 );
				float temp_output_7_0_g22183 = _MainTexColorRemap.x;
				float3 temp_cast_2 = (temp_output_7_0_g22183).xxx;
				float3 temp_output_9_0_g22183 = ( clampResult17_g22408 - temp_cast_2 );
				float3 temp_output_1765_0_g1 = saturate( ( temp_output_9_0_g22183 / ( _MainTexColorRemap.y - temp_output_7_0_g22183 ) ) );
				half Element_Remap_R73_g1 = (temp_output_1765_0_g1).x;
				half Element_Remap_G265_g1 = (temp_output_1765_0_g1).y;
				float3 appendResult274_g1 = (float3((Element_Remap_R73_g1*2.0 + -1.0) , 0.0 , (Element_Remap_G265_g1*2.0 + -1.0)));
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float3 break281_g1 = ( mul( unity_ObjectToWorld, float4( appendResult274_g1 , 0.0 ) ).xyz / ase_objectScale );
				float2 appendResult1403_g1 = (float2(break281_g1.x , break281_g1.z));
				half2 Direction_Texture284_g1 = appendResult1403_g1;
				half Element_InvertMode489_g1 = _ElementInvertMode;
				float2 lerpResult1471_g1 = lerp( Direction_Texture284_g1 , -Direction_Texture284_g1 , Element_InvertMode489_g1);
				float3 appendResult292_g1 = (float3((lerpResult1471_g1*0.5 + 0.5) , 0.0));
				half3 Final_MotionInteraction_RGB303_g1 = appendResult292_g1;
				float clampResult17_g22409 = clamp( (MainTex_RGBA587_g1).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g22149 = _MainTexAlphaRemap.x;
				float temp_output_9_0_g22149 = ( clampResult17_g22409 - temp_output_7_0_g22149 );
				half Element_Remap_A74_g1 = saturate( ( ( temp_output_9_0_g22149 / ( _MainTexAlphaRemap.y - temp_output_7_0_g22149 ) ) + 0.0001 ) );
				half4 _ElementParams_Instance = UNITY_ACCESS_INSTANCED_PROP(_ElementParams_arr, _ElementParams);
				half Element_Params_A1737_g1 = _ElementParams_Instance.w;
				half Element_Falloff1883_g1 = 1.0;
				float temp_output_7_0_g22413 = 1.0;
				float temp_output_9_0_g22413 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g22413 );
				float lerpResult18_g22411 = lerp( 1.0 , saturate( ( temp_output_9_0_g22413 / ( _ElementVolumeFadeValue - temp_output_7_0_g22413 ) ) ) , _ElementVolumeFadeMode);
				...
				half Final_MotionInteraction_A305_g1 = Element_Alpha56_g1;
				float4 appendResult479_g1 = (float4(Final_MotionInteraction_RGB303_g1 , Final_MotionInteraction_A305_g1));
				
				
				finalColor = appendResult479_g1;
				return finalColor;
			}
			ENDCG
		}
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsFlowInteractionSimple
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 appendResult292_g1 = (float3((lerpResult1471_g1*0.5 + 0.5) , 0.0));
				half3 Final_MotionInteraction_RGB303_g1 = appendResult292_g1;
				half3 Input_Color94_g76859 = Final_MotionInteraction_RGB303_g1;
				half3 Element_Valid47_g76859 = ( Input_Color94_g76859 * Input_Color94_g76859 );
				float clampResult17_g22409 = clamp( (MainTex_RGBA587_g1).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g22149 = _MainTexAlphaRemap.x;
				float temp_output_9_0_g22149 = ( clampResult17_g22409 - temp_output_7_0_g22149 );
				half Element_Remap_A74_g1 = saturate( ( ( temp_output_9_0_g22149 / ( _MainTexAlphaRemap.y - temp_output_7_0_g22149 ) ) + 0.0001 ) );
				...
				half Element_Alpha56_g1 = ( _ElementIntensity * Element_Remap_A74_g1 * Element_Params_A1737_g1 * i.ase_color.a * Element_Falloff1883_g1 * lerpResult18_g22411 );
				half Final_MotionInteraction_A305_g1 = Element_Alpha56_g1;
				half Input_Alpha48_g76859 = Final_MotionInteraction_A305_g1;
				float4 appendResult58_g76859 = (float4(Element_Valid47_g76859 , Input_Alpha48_g76859));
				
				
				finalColor = appendResult58_g76859;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;456;-384,-896;Inherit;False;Element Shader;10;;1;0e972c73cae2ee54ea51acc9738801d0;12,477,2,1778,2,478,0,1824,0,1814,3,145,3,1784,2,481,2,1933,1,1935,1,1904,0,1907,0;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;382;-64,-896;Float;False;True;-1;2;TVEShaderGUIElement;100;14;BOXOPHOBIC/The Visual Engine/Elements/Flow Interaction (Simple);f4f273c3bb6262d4396be458405e60f9;True;VolumePass;0;0;VolumePass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=True=DisableBatching;False;False;0;True;True;2;5;False;;10;False;;2;5;False;;10;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;True;True;True;True;True;False;0;False;_render_colormask;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;3;False;;True;True;0;False;;0;False;;False;True;2;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;2;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;383;-64,-768;Float;False;False;-1;2;ASEMaterialInspector;100;14;New Amplify Shader;f4f273c3bb6262d4396be458405e60f9;True;VisualPass;0;1;VisualPass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;RenderType=Opaque=RenderType;False;False;0;True;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;True;True;True;True;True;True;0;False;_render_colormask;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;False;0;False;;0;False;;False;True;2;False;0;;0;0;Standard;0;False;0
WireConnection;456;1974;428;4
WireConnection;382;0;456;0
WireConnection;383;0;456;1779
ASEEND*/
//CHKSM=1E93EC91254ADE91E6E16E5A886F243D0738814C