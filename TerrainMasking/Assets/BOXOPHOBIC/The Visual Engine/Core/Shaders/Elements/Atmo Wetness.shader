...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoWetness
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g24362 = _SeasonRemap.x;
				half temp_output_9_0_g24362 = ( TVE_SeasonLerp - temp_output_7_0_g24362 );
				half TVE_SeasonLerp54_g24346 = saturate( saturate( ( temp_output_9_0_g24362 / ( _SeasonRemap.y - temp_output_7_0_g24362 ) ) ) );
				...
				half2 vertexToFrag11_g24369 = ( ( lerpResult1899_g24346 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g24369;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g24369 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g24346 = tex2D( _MainTex, vertexToFrag11_g24369 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g24363 = clamp( (MainTex_RGBA587_g24346).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g24353 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g24353).xxx;
				half3 temp_output_9_0_g24353 = ( clampResult17_g24363 - temp_cast_2 );
				...
				half clampResult17_g24364 = clamp( (MainTex_RGBA587_g24346).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24352 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g24352 = ( clampResult17_g24364 - temp_output_7_0_g24352 );
				...
				half temp_output_7_0_g24368 = 1.0;
				half temp_output_9_0_g24368 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g24368 );
				half lerpResult18_g24366 = lerp( 1.0 , saturate( ( temp_output_9_0_g24368 / ( _ElementVolumeFadeValue - temp_output_7_0_g24368 ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g24346 = ( _ElementIntensity * Element_Remap_A74_g24346 * Element_Params_A1737_g24346 * i.ase_color.a * Element_Falloff1883_g24346 * lerpResult18_g24366 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoWetness
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g24358 = temp_cast_3;
				half3 break68_g24358 = Input_Color94_g24358;
				half clampResult80_g24358 = clamp( max( max( break68_g24358.x , break68_g24358.y ) , break68_g24358.z ) , 0.1 , 10000.0 );
				half4 color1873_g24346 = IsGammaSpace() ? half4(0,0.7,0.6,0) : half4(0,0.4479884,0.3185468,0);
				half3 Input_Tint76_g24358 = (color1873_g24346).rgb;
				half3 Element_Valid47_g24358 = ( clampResult80_g24358 * Input_Tint76_g24358 );
				half clampResult17_g24364 = clamp( (MainTex_RGBA587_g24346).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24352 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g24352 = ( clampResult17_g24364 - temp_output_7_0_g24352 );
				half Element_Remap_A74_g24346 = saturate( ( ( temp_output_9_0_g24352 / ( _MainTexAlphaRemap.y - temp_output_7_0_g24352 ) ) + 0.0001 ) );
				...
				half Element_Alpha56_g24346 = ( _ElementIntensity * Element_Remap_A74_g24346 * Element_Params_A1737_g24346 * i.ase_color.a * Element_Falloff1883_g24346 * lerpResult18_g24366 );
				half Final_Extras_A241_g24346 = Element_Alpha56_g24346;
				half Input_Alpha48_g24358 = Final_Extras_A241_g24346;
				half4 appendResult58_g24358 = (half4(Element_Valid47_g24358 , Input_Alpha48_g24358));
				
				
				finalColor = appendResult58_g24358;
				return finalColor;
			}
			ENDCG
		}
...
ASEEND*/
//CHKSM=125C9B390AE1270011099A537236919037DD1DFC