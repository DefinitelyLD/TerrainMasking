...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintNoise
			...
			v2f vert ( appdata v )
			{
				...
				o.ase_texcoord1.zw = vertexToFrag11_g24817;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g24817 = i.ase_texcoord1.zw;
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintNoise
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 lerpResult772_g24794 = lerp( _NoiseColorOne , _NoiseColorTwo , WorldNoise1483_g24794);
				half3 Final_ColorsNoise_RGB784_g24794 = (lerpResult772_g24794).rgb;
				half3 Input_Color94_g24804 = Final_ColorsNoise_RGB784_g24794;
				half3 Element_Valid47_g24804 = Input_Color94_g24804;
				half2 vertexToFrag11_g24817 = i.ase_texcoord1.zw;
				half4 MainTex_RGBA587_g24794 = tex2D( _MainTex, vertexToFrag11_g24817 );
				half clampResult17_g24812 = clamp( (MainTex_RGBA587_g24794).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24800 = _MainTexAlphaRemap.x;
				...
				half Element_Seasons834_g24794 = vertexToFrag11_g24797;
				half Final_ColorsNoise_A785_g24794 = ( (lerpResult772_g24794).a * Element_Alpha56_g24794 * Element_Seasons834_g24794 );
				half Input_Alpha48_g24804 = Final_ColorsNoise_A785_g24794;
				half4 appendResult58_g24804 = (half4(Element_Valid47_g24804 , Input_Alpha48_g24804));
				
				
				finalColor = appendResult58_g24804;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;181;-64,-768;Inherit;False;Element Compile;-1;;76843;5302407fc6d65554791e558e67d59358;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=4742BB30E8A637DC43C27A48307C3BDB44609A5A