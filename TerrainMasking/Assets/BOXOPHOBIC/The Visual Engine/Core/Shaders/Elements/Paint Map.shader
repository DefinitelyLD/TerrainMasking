...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintMap
			...
			v2f vert ( appdata v )
			{
				...
				half2 vertexToFrag11_g24817 = ( ( lerpResult1899_g24794 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.xy = vertexToFrag11_g24817;
				...
				half temp_output_7_0_g24810 = _SeasonRemap.x;
				half temp_output_9_0_g24810 = ( TVE_SeasonLerp - temp_output_7_0_g24810 );
				half TVE_SeasonLerp54_g24794 = saturate( saturate( ( temp_output_9_0_g24810 / ( _SeasonRemap.y - temp_output_7_0_g24810 ) ) ) );
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g24817 = i.ase_texcoord1.xy;
				half4 MainTex_RGBA587_g24794 = tex2D( _MainTex, vertexToFrag11_g24817 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g24811 = clamp( (MainTex_RGBA587_g24794).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g24801 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g24801).xxx;
				half3 temp_output_9_0_g24801 = ( clampResult17_g24811 - temp_cast_2 );
				...
				half clampResult17_g24812 = clamp( (MainTex_RGBA587_g24794).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24800 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g24800 = ( clampResult17_g24812 - temp_output_7_0_g24800 );
				...
				half temp_output_7_0_g24816 = 1.0;
				half temp_output_9_0_g24816 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g24816 );
				half lerpResult18_g24814 = lerp( 1.0 , saturate( ( temp_output_9_0_g24816 / ( _ElementVolumeFadeValue - temp_output_7_0_g24816 ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g24794 = ( _ElementIntensity * Element_Remap_A74_g24794 * Element_Params_A1737_g24794 * i.ase_color.a * Element_Falloff1883_g24794 * lerpResult18_g24814 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintMap
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Element_Remap_RGB1555_g24794 = temp_output_1765_0_g24794;
				half3 Final_ColorsMap_RGB598_g24794 = ( (Color_Main_RGBA49_g24794).rgb * Element_Remap_RGB1555_g24794 );
				half3 Input_Color94_g24803 = Final_ColorsMap_RGB598_g24794;
				half3 Element_Valid47_g24803 = Input_Color94_g24803;
				half clampResult17_g24812 = clamp( (MainTex_RGBA587_g24794).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24800 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g24800 = ( clampResult17_g24812 - temp_output_7_0_g24800 );
				half Element_Remap_A74_g24794 = saturate( ( ( temp_output_9_0_g24800 / ( _MainTexAlphaRemap.y - temp_output_7_0_g24800 ) ) + 0.0001 ) );
				...
				half Element_Seasons834_g24794 = vertexToFrag11_g24797;
				half Final_ColorsMap_A603_g24794 = ( Element_Alpha56_g24794 * Element_Seasons834_g24794 );
				half Input_Alpha48_g24803 = Final_ColorsMap_A603_g24794;
				half4 appendResult58_g24803 = (half4(Element_Valid47_g24803 , Input_Alpha48_g24803));
				
				
				finalColor = appendResult58_g24803;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;152;-64,-768;Inherit;False;Element Compile;-1;;76843;5302407fc6d65554791e558e67d59358;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=1CFF52BA4C3AA84D405584B3B1FB138C143C4509