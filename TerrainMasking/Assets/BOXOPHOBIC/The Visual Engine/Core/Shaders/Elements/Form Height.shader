...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsFormHeight
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g23899 = _SeasonRemap.x;
				half temp_output_9_0_g23899 = ( TVE_SeasonLerp - temp_output_7_0_g23899 );
				half TVE_SeasonLerp54_g23883 = saturate( saturate( ( temp_output_9_0_g23899 / ( _SeasonRemap.y - temp_output_7_0_g23899 ) ) ) );
				...
				half2 vertexToFrag11_g23906 = ( ( lerpResult1899_g23883 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g23906;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g23906 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g23883 = tex2D( _MainTex, vertexToFrag11_g23906 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g23900 = clamp( (MainTex_RGBA587_g23883).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g23890 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g23890).xxx;
				half3 temp_output_9_0_g23890 = ( clampResult17_g23900 - temp_cast_2 );
				half3 temp_output_1765_0_g23883 = saturate( ( temp_output_9_0_g23890 / ( _MainTexColorRemap.y - temp_output_7_0_g23890 ) ) );
				...
				half clampResult17_g23901 = clamp( (MainTex_RGBA587_g23883).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23889 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g23889 = ( clampResult17_g23901 - temp_output_7_0_g23889 );
				half Element_Remap_A74_g23883 = saturate( ( ( temp_output_9_0_g23889 / ( _MainTexAlphaRemap.y - temp_output_7_0_g23889 ) ) + 0.0001 ) );
				half Element_Params_A1737_g23883 = _ElementParams_Instance.w;
				half clampResult17_g23887 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g23888 = _MainTexFalloffRemap.x;
				half temp_output_9_0_g23888 = ( clampResult17_g23887 - temp_output_7_0_g23888 );
				half Element_Falloff1883_g23883 = saturate( ( ( temp_output_9_0_g23888 / ( _MainTexFalloffRemap.y - temp_output_7_0_g23888 ) ) + 0.0001 ) );
				half temp_output_7_0_g23905 = 1.0;
				half temp_output_9_0_g23905 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23905 );
				half lerpResult18_g23903 = lerp( 1.0 , saturate( ( temp_output_9_0_g23905 / ( _ElementVolumeFadeValue - temp_output_7_0_g23905 ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g23883 = ( _ElementIntensity * Element_Remap_A74_g23883 * Element_Params_A1737_g23883 * i.ase_color.a * Element_Falloff1883_g23883 * lerpResult18_g23903 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsFormHeight
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g76839 = temp_cast_3;
				half3 break68_g76839 = Input_Color94_g76839;
				half clampResult80_g76839 = clamp( max( max( break68_g76839.x , break68_g76839.y ) , break68_g76839.z ) , 0.1 , 10000.0 );
				half4 color1938_g23883 = IsGammaSpace() ? half4(0,0.2,1,0) : half4(0,0.03310476,1,0);
				half3 Input_Tint76_g76839 = (color1938_g23883).rgb;
				half3 Element_Valid47_g76839 = ( clampResult80_g76839 * Input_Tint76_g76839 );
				half clampResult17_g23901 = clamp( (MainTex_RGBA587_g23883).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23889 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g23889 = ( clampResult17_g23901 - temp_output_7_0_g23889 );
				half Element_Remap_A74_g23883 = saturate( ( ( temp_output_9_0_g23889 / ( _MainTexAlphaRemap.y - temp_output_7_0_g23889 ) ) + 0.0001 ) );
				...
				half Element_Alpha56_g23883 = ( _ElementIntensity * Element_Remap_A74_g23883 * Element_Params_A1737_g23883 * i.ase_color.a * Element_Falloff1883_g23883 * lerpResult18_g23903 );
				half Final_Extras_A241_g23883 = Element_Alpha56_g23883;
				half Input_Alpha48_g76839 = Final_Extras_A241_g23883;
				half4 appendResult58_g76839 = (half4(Element_Valid47_g76839 , Input_Alpha48_g76839));
				
				
				finalColor = appendResult58_g76839;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;216;-512,-896;Inherit;False;Element Shader;10;;23883;0e972c73cae2ee54ea51acc9738801d0;12,477,3,1778,3,478,0,1824,0,1814,1,145,1,1784,2,481,2,1933,0,1935,0,1904,1,1907,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
...
ASEEND*/
//CHKSM=DF79CE07943472B2D7F7968C730054316F812224