...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintIntensity
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g24811 = _SeasonRemap.x;
				half temp_output_9_0_g24811 = ( TVE_SeasonLerp - temp_output_7_0_g24811 );
				half TVE_SeasonLerp54_g24795 = saturate( saturate( ( temp_output_9_0_g24811 / ( _SeasonRemap.y - temp_output_7_0_g24811 ) ) ) );
				...
				half2 vertexToFrag11_g24818 = ( ( lerpResult1899_g24795 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g24818;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g24818 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g24795 = tex2D( _MainTex, vertexToFrag11_g24818 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g24812 = clamp( (MainTex_RGBA587_g24795).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g24802 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g24802).xxx;
				half3 temp_output_9_0_g24802 = ( clampResult17_g24812 - temp_cast_2 );
				...
				half clampResult17_g24813 = clamp( (MainTex_RGBA587_g24795).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24801 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g24801 = ( clampResult17_g24813 - temp_output_7_0_g24801 );
				...
				half temp_output_7_0_g24817 = 1.0;
				half temp_output_9_0_g24817 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g24817 );
				half lerpResult18_g24815 = lerp( 1.0 , saturate( ( temp_output_9_0_g24817 / ( _ElementVolumeFadeValue - temp_output_7_0_g24817 ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g24795 = ( _ElementIntensity * Element_Remap_A74_g24795 * Element_Params_A1737_g24795 * i.ase_color.a * Element_Falloff1883_g24795 * lerpResult18_g24815 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsPaintIntensity
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g24806 = temp_cast_3;
				half3 break68_g24806 = Input_Color94_g24806;
				half clampResult80_g24806 = clamp( max( max( break68_g24806.x , break68_g24806.y ) , break68_g24806.z ) , 0.1 , 10000.0 );
				half4 color1871_g24795 = IsGammaSpace() ? half4(1,0.5,0.5,0) : half4(1,0.2140411,0.2140411,0);
				half3 Input_Tint76_g24806 = (color1871_g24795).rgb;
				half3 Element_Valid47_g24806 = ( clampResult80_g24806 * Input_Tint76_g24806 );
				half clampResult17_g24813 = clamp( (MainTex_RGBA587_g24795).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g24801 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g24801 = ( clampResult17_g24813 - temp_output_7_0_g24801 );
				half Element_Remap_A74_g24795 = saturate( ( ( temp_output_9_0_g24801 / ( _MainTexAlphaRemap.y - temp_output_7_0_g24801 ) ) + 0.0001 ) );
				...
				half Input_Alpha48_g24806 = Final_Extras_A241_g24795;
...
ASEEND*/
//CHKSM=02E1AB0506BE1978AB2A0801BBEB621566BB849A