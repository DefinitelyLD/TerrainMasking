...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsGlowEmissive
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_7_0_g23654 = _SeasonRemap.x;
				float temp_output_9_0_g23654 = ( TVE_SeasonLerp - temp_output_7_0_g23654 );
				...
				float2 vertexToFrag11_g23661 = ( ( lerpResult1899_g23638 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord2.xy = vertexToFrag11_g23661;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 vertexToFrag11_g23661 = i.ase_texcoord2.xy;
				...
				float3 clampResult17_g23655 = clamp( (MainTex_RGBA587_g23638).rgb , temp_cast_0 , temp_cast_1 );
				float temp_output_7_0_g23645 = _MainTexColorRemap.x;
				float3 temp_cast_2 = (temp_output_7_0_g23645).xxx;
				float3 temp_output_9_0_g23645 = ( clampResult17_g23655 - temp_cast_2 );
				...
				float clampResult17_g23656 = clamp( (MainTex_RGBA587_g23638).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g23644 = _MainTexAlphaRemap.x;
				float temp_output_9_0_g23644 = ( clampResult17_g23656 - temp_output_7_0_g23644 );
				...
				float temp_output_7_0_g23660 = 1.0;
				float temp_output_9_0_g23660 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23660 );
				float lerpResult18_g23658 = lerp( 1.0 , saturate( ( temp_output_9_0_g23660 / ( _ElementVolumeFadeValue - temp_output_7_0_g23660 ) ) ) , _ElementVolumeFadeMode);
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsGlowEmissive
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Element_Color1756_g23638 = ( Element_Remap_RGB1555_g23638 * Element_Params_RGB1735_g23638 * (i.ase_color).rgb );
				half3 Final_Colors_RGB142_g23638 = ( (lerpResult30_g23638).rgb * Element_Color1756_g23638 );
				half3 Input_Color94_g23646 = Final_Colors_RGB142_g23638;
				half3 Element_Valid47_g23646 = Input_Color94_g23646;
				float clampResult17_g23656 = clamp( (MainTex_RGBA587_g23638).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g23644 = _MainTexAlphaRemap.x;
				float temp_output_9_0_g23644 = ( clampResult17_g23656 - temp_output_7_0_g23644 );
				half Element_Remap_A74_g23638 = saturate( ( ( temp_output_9_0_g23644 / ( _MainTexAlphaRemap.y - temp_output_7_0_g23644 ) ) + 0.0001 ) );
				...
				half Element_Alpha56_g23638 = ( _ElementIntensity * Element_Remap_A74_g23638 * Element_Params_A1737_g23638 * i.ase_color.a * Element_Falloff1883_g23638 * lerpResult18_g23658 );
				half Final_Colors_A144_g23638 = ( (lerpResult30_g23638).a * Element_Alpha56_g23638 );
				half Input_Alpha48_g23646 = Final_Colors_A144_g23638;
				float4 appendResult58_g23646 = (float4(Element_Valid47_g23646 , Input_Alpha48_g23646));
				
				
				finalColor = appendResult58_g23646;
				return finalColor;
			}
			ENDCG
		}
...
ASEEND*/
//CHKSM=B4366309A644894C40A54B6907DE4A084541955A