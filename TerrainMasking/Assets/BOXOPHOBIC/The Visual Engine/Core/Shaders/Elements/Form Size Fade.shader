...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsFormSizeFade
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g23792 = _SeasonRemap.x;
				half temp_output_9_0_g23792 = ( TVE_SeasonLerp - temp_output_7_0_g23792 );
				half TVE_SeasonLerp54_g23776 = saturate( saturate( ( temp_output_9_0_g23792 / ( _SeasonRemap.y - temp_output_7_0_g23792 ) ) ) );
				...
				half2 vertexToFrag11_g23799 = ( ( lerpResult1899_g23776 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g23799;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g23799 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g23776 = tex2D( _MainTex, vertexToFrag11_g23799 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g23793 = clamp( (MainTex_RGBA587_g23776).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g23783 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g23783).xxx;
				half3 temp_output_9_0_g23783 = ( clampResult17_g23793 - temp_cast_2 );
				half3 temp_output_1765_0_g23776 = saturate( ( temp_output_9_0_g23783 / ( _MainTexColorRemap.y - temp_output_7_0_g23783 ) ) );
				...
				half clampResult17_g23794 = clamp( (MainTex_RGBA587_g23776).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23782 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g23782 = ( clampResult17_g23794 - temp_output_7_0_g23782 );
				half Element_Remap_A74_g23776 = saturate( ( ( temp_output_9_0_g23782 / ( _MainTexAlphaRemap.y - temp_output_7_0_g23782 ) ) + 0.0001 ) );
				half Element_Params_A1737_g23776 = _ElementParams_Instance.w;
				half clampResult17_g23780 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g23781 = _MainTexFalloffRemap.x;
				half temp_output_9_0_g23781 = ( clampResult17_g23780 - temp_output_7_0_g23781 );
				half Element_Falloff1883_g23776 = saturate( ( ( temp_output_9_0_g23781 / ( _MainTexFalloffRemap.y - temp_output_7_0_g23781 ) ) + 0.0001 ) );
				half temp_output_7_0_g23798 = 1.0;
				half temp_output_9_0_g23798 = ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23798 );
				half lerpResult18_g23796 = lerp( 1.0 , saturate( ( temp_output_9_0_g23798 / ( _ElementVolumeFadeValue - temp_output_7_0_g23798 ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g23776 = ( _ElementIntensity * Element_Remap_A74_g23776 * Element_Params_A1737_g23776 * i.ase_color.a * Element_Falloff1883_g23776 * lerpResult18_g23796 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsFormSizeFade
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g76838 = temp_cast_3;
				half3 break68_g76838 = Input_Color94_g76838;
				half clampResult80_g76838 = clamp( max( max( break68_g76838.x , break68_g76838.y ) , break68_g76838.z ) , 0.1 , 10000.0 );
				half4 color1877_g23776 = IsGammaSpace() ? half4(0,1,0,0) : half4(0,1,0,0);
				half3 Input_Tint76_g76838 = (color1877_g23776).rgb;
				half3 Element_Valid47_g76838 = ( clampResult80_g76838 * Input_Tint76_g76838 );
				half clampResult17_g23794 = clamp( (MainTex_RGBA587_g23776).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23782 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g23782 = ( clampResult17_g23794 - temp_output_7_0_g23782 );
				half Element_Remap_A74_g23776 = saturate( ( ( temp_output_9_0_g23782 / ( _MainTexAlphaRemap.y - temp_output_7_0_g23782 ) ) + 0.0001 ) );
				...
				half Input_Alpha48_g76838 = Final_Extras_A241_g23776;
				half4 appendResult58_g76838 = (half4(Element_Valid47_g76838 , Input_Alpha48_g76838));
				
				
				finalColor = appendResult58_g76838;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;186;-512,-896;Inherit;False;Element Shader;10;;23776;0e972c73cae2ee54ea51acc9738801d0;12,477,3,1778,3,478,0,1824,0,1814,1,145,1,1784,2,481,2,1933,1,1935,1,1904,1,1907,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
Node;AmplifyShaderEditor.FunctionNode;137;-192,-1280;Inherit;False;Element Compile;-1;;76843;5302407fc6d65554791e558e67d59358;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=BE24FA939AF1EF7B5F2253EBB22D1E159A6C7C32