...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoDryness
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g23468 = temp_cast_3;
				half3 break68_g23468 = Input_Color94_g23468;
				half clampResult80_g23468 = clamp( max( max( break68_g23468.x , break68_g23468.y ) , break68_g23468.z ) , 0.1 , 10000.0 );
				half4 color1872_g23453 = IsGammaSpace() ? half4(1,0.6,0,0) : half4(1,0.3185468,0,0);
				half3 Input_Tint76_g23468 = (color1872_g23453).rgb;
				half3 Element_Valid47_g23468 = ( clampResult80_g23468 * Input_Tint76_g23468 );
				half clampResult17_g23471 = clamp( (MainTex_RGBA587_g23453).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23459 = _MainTexAlphaRemap.x;
				half temp_output_9_0_g23459 = ( clampResult17_g23471 - temp_output_7_0_g23459 );
				half Element_Remap_A74_g23453 = saturate( ( ( temp_output_9_0_g23459 / ( _MainTexAlphaRemap.y - temp_output_7_0_g23459 ) ) + 0.0001 ) );
				...
				half Element_Alpha56_g23453 = ( _ElementIntensity * Element_Remap_A74_g23453 * Element_Params_A1737_g23453 * i.ase_color.a * Element_Falloff1883_g23453 * lerpResult18_g23473 );
				half Final_Extras_A241_g23453 = Element_Alpha56_g23453;
				half Input_Alpha48_g23468 = Final_Extras_A241_g23453;
				half4 appendResult58_g23468 = (half4(Element_Valid47_g23468 , Input_Alpha48_g23468));
				
				
				finalColor = appendResult58_g23468;
				return finalColor;
			}
			ENDCG
		}
...
ASEEND*/
//CHKSM=DAC3F7ADDA045E677DDBB103243D29489CFA3E7C