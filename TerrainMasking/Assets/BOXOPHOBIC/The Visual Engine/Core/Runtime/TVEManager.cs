...
namespace TheVisualEngine
{
    ...
    public class TVEManager : StyledMonoBehaviour
    {
        ...
        void SetGlobalShaderProperties()
        {
            ...
            var formParams = new Vector4(0.5f, 0.5f, 0.0f, globalFormData.sizeFadeIntensity);
            ...
            Shader.SetGlobalVector("TVE_MotionParams", new Vector4(motionDirection.x * 0.5f + 0.5f, motionDirection.z * 0.5f + 0.5f, motionIntensity, 1));

            Shader.SetGlobalVector("TVE_FlowParams", new Vector4(0.5f, 0.5f, 0.0f, motionIntensity));
        }
