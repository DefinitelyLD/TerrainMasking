	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_ATexture = packedInput.ase_texcoord6.xy * _ATexture_ST.xy + _ATexture_ST.zw;
				
				float2 uv_NTexture = packedInput.ase_texcoord6.xy * _NTexture_ST.xy + _NTexture_ST.zw;
				float3 unpack7 = UnpackNormalScale( tex2D( _NTexture, uv_NTexture ), _Normal );
				unpack7.z = lerp( 1, unpack7.z, saturate(_Normal) );
				
				float2 uv_MTexture = packedInput.ase_texcoord6.xy * _MTexture_ST.xy + _MTexture_ST.zw;
				float4 tex2DNode8 = tex2D( _MTexture, uv_MTexture );
				
				float2 uv_OTexture = packedInput.ase_texcoord6.xy * _OTexture_ST.xy + _OTexture_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_NTexture = packedInput.ase_texcoord4.xy * _NTexture_ST.xy + _NTexture_ST.zw;
				float3 unpack7 = UnpackNormalScale( tex2D( _NTexture, uv_NTexture ), _Normal );
				unpack7.z = lerp( 1, unpack7.z, saturate(_Normal) );
				
				float2 uv_MTexture = packedInput.ase_texcoord4.xy * _MTexture_ST.xy + _MTexture_ST.zw;
				float4 tex2DNode8 = tex2D( _MTexture, uv_MTexture );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_ATexture = packedInput.ase_texcoord8.xy * _ATexture_ST.xy + _ATexture_ST.zw;
				
				float2 uv_NTexture = packedInput.ase_texcoord8.xy * _NTexture_ST.xy + _NTexture_ST.zw;
				float3 unpack7 = UnpackNormalScale( tex2D( _NTexture, uv_NTexture ), _Normal );
				unpack7.z = lerp( 1, unpack7.z, saturate(_Normal) );
				
				float2 uv_MTexture = packedInput.ase_texcoord8.xy * _MTexture_ST.xy + _MTexture_ST.zw;
				float4 tex2DNode8 = tex2D( _MTexture, uv_MTexture );
				
				float2 uv_OTexture = packedInput.ase_texcoord8.xy * _OTexture_ST.xy + _OTexture_ST.zw;
...
ASEEND*/
//CHKSM=AB60945CEE2875706EB1690ACF9264FD0D5EDFCF